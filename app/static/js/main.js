...
$(document).ready(function(){
    ...
    $('.bg-1 .sl-slide-inner , .bg-1 .sl-content-slice').css("background", "url('http://127.0.0.1:8000/static/img/slide1.jpg') center").css("background-size", "cover");
    $('.bg-2 .sl-slide-inner , .bg-1 .sl-content-slice').css("background", "url('http://127.0.0.1:8000/static/img/slide2.jpg') center").css("background-size", "cover");
    $('.bg-3 .sl-slide-inner , .bg-1 .sl-content-slice').css("background", "url('http://127.0.0.1:8000/static/img/slide3.jpg') center").css("background-size", "cover");
    $('.bg-5 .sl-slide-inner , .bg-1 .sl-content-slice').css("background", "url('http://127.0.0.1:8000/static/img/slide5.jpg') center").css("background-size", "cover");
